...
class BaseModel(nn.Module):
    ...
    def device(self):
        ...
        if len(param_list) > 0:
            return param_list[0].device
        else:
            return torch.device("cpu") # no params, an api call. TODO: fix as this is a hack
    ...
    def default_config_path(cls, model_type):
        ...
        ), "Unknown model type {}. Known model types are {}".format(model_type, cls.PRETRAINED_MODEL_CONFIG_DICT.keys())
