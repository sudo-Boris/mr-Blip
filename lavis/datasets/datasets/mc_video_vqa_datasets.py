...
class MCVideoQADataset(MultimodalClassificationDataset, __DisplMixin):
    ...
    def __getitem__(self, index):
        ...
        while result is None:
            ...
            qa_prompt = (
                prompt
                + " Considering the information presented in the frames, select the correct answer from the options."
            )
            # loc_prompt = "Query: " + q + "\n"
            loc_prompt = "Query: " + q + " " + hints + "\n"
            ...
            assert (len(frms) == self.vis_processor.n_frms) or self.vis_processor.fps is not None
            ...
            #     print(f"Error while read file idx {index}: {e}")
