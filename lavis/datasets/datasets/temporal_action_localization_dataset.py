...
class TemporalActionLocalizationDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        task_prompt = "Given the video, temporally locate the actions and predict the action class.\nRelevant windows: "
        ...
        # Train with with 50/50 chance of having query prompt
        # Later evaluate with query prompt for the real TAL setting
        # if self.data_type == "train":
        #     # sample random number betweeon 0 and 1
