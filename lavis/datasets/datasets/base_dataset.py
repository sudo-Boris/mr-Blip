...
class BaseDataset(Dataset):
    def __init__(
        self, vis_processor=None, text_processor=None, vis_root=None, ann_paths=[], start_idx=None, end_idx=None
    ):
        """
        ...
        if start_idx is None:
            start_idx = 0
        if end_idx is None:
            end_idx = len(self.annotation) + 1
        self.annotation = self.annotation[start_idx:end_idx]
